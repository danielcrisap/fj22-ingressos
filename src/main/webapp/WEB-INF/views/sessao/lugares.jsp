...
<ingresso:template>
	<jsp:attribute name="compra_css">
		<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/compra.css"/>
    </jsp:attribute>
    <jsp:body>
        <div class="container-compra">
            ...
            <div class="main">
                ...
                <table class="table-compra" id="lugares">
                    <caption hidden>Lugares</caption>
                    <tbody>
                    <c:forEach var="map" items="${sessao.mapaDeLugares}">
                        <tr class="fileira">
                            ...
                            <td class="fileira-assentos">
                                <table>
                                    <caption hidden>Fileira</caption>
                                    <tr>
                                            ...
                                            <td class="fileira-assento">
                                                <figure>
                                                    <svg class="assento ${sessao.isDisponivel(lugar) && !carrinho.isSelecionado(lugar) ? 'disponivel' : 'ocupado'}"
                                                         ...
                                                         accumulate="new 0 0 318.224 305.246"
                                                         xml:space="preserve">
											<g id="FILL">
                ...
                <div class="tipoIngresso">
                    <form action="${pageContext.request.contextPath}/compra/ingressos" method="post">
                        <table class="table table-hover" id="tabela-ingressos">
                            ...
                            <th id="tipo_ingresso">Tipo de Ingresso</th>
                            </thead>
                            <tbody>
